...
Valid rule names are:
  ...
  tooltipPlacementTop
  tooltipPlacementBottom. classes has the following type: dict containing keys 'tooltip', 'tooltipArrow', 'arrow', 'tooltipPlacementLeft', 'tooltipPlacementRight', 'tooltipPlacementTop', 'tooltipPlacementBottom'.
