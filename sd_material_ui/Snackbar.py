...
- action (string; optional): The text of the action button inside the snackbar. If empty, no action button will be added
...
- message (a list of or a singular dash component, string or number; optional): The message to be displayed.
...
- open (boolean; optional): Controls whether the Snackbar is opened or not
- style (dict; optional): Override the inline styles of the root element"""
    ...
    def __init__(self, children=None, action=Component.UNDEFINED, actionStyles=Component.UNDEFINED, autoHideDuration=Component.UNDEFINED, classes=Component.UNDEFINED, className=Component.UNDEFINED, fireEvent=Component.UNDEFINED, id=Component.REQUIRED, message=Component.UNDEFINED, n_clicks=Component.UNDEFINED, open=Component.UNDEFINED, style=Component.UNDEFINED, bodyStyle=Component.UNDEFINED, contentStyle=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'action', 'actionStyles', 'autoHideDuration', 'classes', 'className', 'id', 'message', 'n_clicks', 'open', 'style']
        self._type = 'Snackbar'
        self._namespace = 'sd_material_ui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'action', 'actionStyles', 'autoHideDuration', 'classes', 'className', 'id', 'message', 'n_clicks', 'open', 'style']
