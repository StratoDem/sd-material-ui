...
Valid rule names are:
  ...
  anchorOriginTopLeft
  anchorOriginBottomLeft. classes has the following type: dict containing keys 'root', 'anchorOriginTopCenter', 'anchorOriginBottomCenter', 'anchorOriginTopRight', 'anchorOriginBottomRight', 'anchorOriginTopLeft', 'anchorOriginBottomLeft'.
...
- style (dict; optional): Override the inline styles of the root element"""
    @_explicitize_args
    def __init__(self, action=Component.UNDEFINED, autoHideDuration=Component.UNDEFINED, classes=Component.UNDEFINED, className=Component.UNDEFINED, fireEvent=Component.UNDEFINED, id=Component.REQUIRED, message=Component.REQUIRED, n_clicks=Component.UNDEFINED, open=Component.UNDEFINED, style=Component.UNDEFINED, bodyStyle=Component.UNDEFINED, contentStyle=Component.UNDEFINED, **kwargs):
        self._prop_names = ['action', 'autoHideDuration', 'classes', 'className', 'id', 'message', 'n_clicks', 'open', 'style']
        self._type = 'Snackbar'
        self._namespace = 'sd_material_ui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['action', 'autoHideDuration', 'classes', 'className', 'id', 'message', 'n_clicks', 'open', 'style']
