...
- expandable (boolean; default False): If true, this card component is expandable.
- expanded (boolean; optional): Set to null to keep the component uncontrolled.
- initiallyExpanded (boolean; default False): Whether this card is initially expanded.
- style (dict; optional): Override the inline-styles of the root element.
- showExpandableButton (boolean; default True): If true, this card component will include a button to expand the card.
- headerActAsExpander (boolean; default True): If true, a click on this card component expands the card.
...
- headerSubtitleColor (string; default ''): Override the subtitle color.
...
- headerTitleColor (string; default ''): Override the title color.
- headerTitleStyle (dict; optional): Override the inline-styles of the title.
- headerIconStyle (dict; optional)
- titleExpandable (boolean; default True): If true, this card component is expandable.
...
- titleSubtitleColor (string; default ''): Override the subtitle color.
...
- titleColor (string; default ''): Override the title color.
- titleTitleStyle (dict; optional): Override the inline-styles of the title.
- textExpandable (boolean; default True): If true, this card component is expandable.
- textColor (string; default ''): Override the CardText color.
