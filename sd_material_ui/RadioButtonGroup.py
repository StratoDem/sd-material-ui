...
- valueSelected (string; required): Initial value selected"""
    @_explicitize_args
    def __init__(self, className=Component.UNDEFINED, fireEvent=Component.UNDEFINED, id=Component.REQUIRED, name=Component.REQUIRED, options=Component.UNDEFINED, valueSelected=Component.REQUIRED, **kwargs):
        self._prop_names = ['className', 'id', 'name', 'options', 'valueSelected']
        self._type = 'RadioButtonGroup'
        self._namespace = 'sd_material_ui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['className', 'id', 'name', 'options', 'valueSelected']
