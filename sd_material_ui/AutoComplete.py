...
Valid rule names are:
  ...
  option
  groupLabel
  groupUl. classes has the following type: dict containing keys 'root', 'fullWidth', 'focus', 'tag', 'tagSizeSmall', 'hasPopupIcon', 'hasClearIcon', 'inputRoot', 'input', 'inputFocused', 'endAdornment', 'clearIndicator', 'clearIndicatorDirty', 'popupIndicator', 'popupIndicatorOpen', 'popper', 'popperDisablePortal', 'paper', 'listbox', 'loading', 'noOptions', 'option', 'groupLabel', 'groupUl'.
